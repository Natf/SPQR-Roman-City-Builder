...
Shader "Polygon Wind" {
    ...
    Properties {
        ...
        _tree_sway_speed ("Tree Sway Speed", range(0,10)) = 0.75
        _tree_sway_disp ("Tree Sway Displacement", range(0,5)) = 4.0

        _branches_disp ("Branches Displacement", range(0,0.5)) = 0.3

        _leaves_wiggle_disp ("Leaves Wiggle Displacement", float) = 0.0
        _leaves_wiggle_speed ("Leaves Wiggle Speed", float) = 0.0
        ...
        #pragma surface surf Lambert vertex:vert addshadow
            ...
            fixed4 _Tint;
                ...
                void vert (inout appdata_full i) {
                    ...
                    i.vertex.y += (cos(_Time.z * _tree_sway_speed + (worldPos.z/_wind_size)) * _tree_sway_disp * _wind_dir.y * (i.vertex.y / 10) * i.color.b) * _b_influence;
                    // just for grass so gunna ignore branches/y movement
                    //Branches Movement
